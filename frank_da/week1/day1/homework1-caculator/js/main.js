...
const combinedFunc = function ( number ) {
  halfNumberResult = halfNumber(number);
  squareNumberResult = squareNumber(halfNumberResult);
  areaNumberResult = areaOfCircle(squareNumberResult);
  percentOfResult = percentOf(areaNumberResult, squareNumberResult);
}
console.log('============');
combinedFunc(9);
