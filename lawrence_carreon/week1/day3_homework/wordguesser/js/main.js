...
alert(`${rules}`); //display the rules to the user
...
const userGuessChecker = function(additionalReward, badGuesses, guessedLetters, lettersRevealed, winCon)
{
    ...
    let incorrectTotal = `You have ${6 - badGuesses} mistakes left!\n\n`;
    ...
    if(badGuesses === 6)
    {
        return alert(`You have reached the maximum number of guesses! RIP YOUR NECK`);
    };
    if(winCon === true)
    {
