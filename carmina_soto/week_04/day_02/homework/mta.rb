...
def plan_trip start_line, start_stop, end_line, end_stop
  ...
  if start_subway == end_subway
    ...
    puts Rainbow("You must travel through the following stops on the #{start_line} line: #{stops.join(', ')}").purple
    puts Rainbow("#{no_of_stops} stops in total").purple
  else
    ...
    no_of_stops = stops.count
    puts Rainbow("You must travel through the following stops on the #{start_line} line: #{start_stops.join(', ')}").purple
    puts Rainbow("Change at Union Square").purple
    puts Rainbow("Your journey continues through the following stops on the #{end_line} line: #{end_stops.join(', ')}").purple
    puts Rainbow("#{no_of_stops} stops in total").purple
  end
end
