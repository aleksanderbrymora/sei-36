...
const f2 = tellFortune(6, 'Glenn', 'the North of France', 'independently wealthy');
console.log( f2 );
...
console.log( calculateDogAge(9, 10.43) );
...
const calculateSupply = function (currentAge, amountPerDay) {
  ...
  // Math.round: rounds up or down, Math.floor always rounds down, Math.ceil always rounds up.
  console.log( `You will need ${ Math.ceil(amountRequired) } to last you until the ripe old age of ${ deathAge }` );
};

calculateSupply(36, 5.3);
calculateSupply(50, 5);
calculateSupply(83.6, 5);
...
fahrenheitToCelsius( celsiusToFahrenheit(24) );
