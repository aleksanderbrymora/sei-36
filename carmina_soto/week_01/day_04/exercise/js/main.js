...
const favRecipe = {
  title: "Crinkles",
  servings: 12,
  ingredients: ["egg", "cocoa powder", "sugar"]
}
...
//
const books = [
  { title: "Harry Potter", author: "JK Rowling", alreadyRead: true },
...
const movieInfo = function(movie){
  let result = `${movie.title} lasts for ${movie.duration} minutes. Stars: ${movie.stars.join (', ')}.`;
  return result;
}
